...
var _1 = require("stalk-js/lib/browser/");
var ServerEventListener = /** @class */ (function () {
    ...
    ServerEventListener.prototype.addServerListener = function (obj) {
        ...
        // <!-- User -->
        self.socket.on(_1.StalkEvents.ON_USER_LOGIN, function (data) {
            console.log(_1.StalkEvents.ON_USER_LOGIN);
            self.serverListener.onUserLogin(data);
        });
        self.socket.on(_1.StalkEvents.ON_USER_LOGOUT, function (data) {
    ...
    ServerEventListener.prototype.addChatListener = function (obj) {
        ...
        self.socket.on(_1.ChatEvents.ON_ADD, function (data) {
            console.log(_1.ChatEvents.ON_ADD, data);
            self.chatServerListener.onRoomJoin(data);
        });
        self.socket.on(_1.ChatEvents.ON_LEAVE, function (data) {
            console.log(_1.ChatEvents.ON_LEAVE, data);
            self.chatServerListener.onLeaveRoom(data);
        });
        self.socket.on(_1.ChatEvents.ON_GET_MESSAGES_READERS, function (data) {
