...
var BackendFactory = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, stalk_js_1.stalkjs.init(this.stalk)];
                    case 1:
                        socket = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, stalk_js_1.stalkjs.geteEnter(this.stalk, msg)];
                    case 1:
                        connector = _a.sent();
                        params = { host: connector.host, port: connector.port, reconnect: false };
                        return [4 /*yield*/, stalk_js_1.stalkjs.handshake(this.stalk, params)];
                    case 2:
                        _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        msg["x-api-version"] = getConfig().Stalk.apiVersion;
                        msg["x-app-id"] = getConfig().Stalk.appId;
                        return [4 /*yield*/, stalk_js_1.stalkjs.checkIn(this.stalk, msg)];
                    case 1:
                        result = _a.sent();
    ...
    BackendFactory.prototype.checkOut = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, stalk_js_1.stalkjs.checkOut(this.stalk)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
