...
var ServiceProvider = __importStar(require("../../services/ServiceProvider"));
...
exports.updateLastAccessRoom = function (room_id, user_id) { return ({ type: UPDATE_LAST_ACCESS_ROOM, payload: ({ room_id: room_id, user_id: user_id }) }); };
...
exports.getLastAccessRoom = function (user_id) { return ({ type: exports.GET_LAST_ACCESS_ROOM, payload: { user_id: user_id } }); };
