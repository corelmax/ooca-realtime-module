...
var chatLog_1 = __importDefault(require("./models/chatLog"));
...
var chatlogActionsHelper = __importStar(require("./redux/chatlogs/chatlogActionsHelper"));
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_1 = _a.sent();
                        if (err_1) {
                            console.warn("getContactProfile fail", err_1.message);
                        }
                        return [3 /*break*/, 4];
                    case 4:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_2 = _a.sent();
                        if (err_2) {
                            console.warn("get sender contact fail", err_2.message);
                        }
                        return [3 /*break*/, 4];
                    case 4:
