        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, server.getLobby().updateUser(msg)];
                case 1: return [2 /*return*/, _a.sent()];
                case 2:
                    ex_1 = _a.sent();
                    return [2 /*return*/, ex_1.message];
