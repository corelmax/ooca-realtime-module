...
var getConfig = function () { return Chitchat_1.chitchatFactory.config; };
var store = function () { return Chitchat_1.chitchatFactory.getStore(); };
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, server.getLobby().getUsersPayload(msg)];
                case 1:
                    result = _a.sent();
                    if (result.code == 200) {
